...
#+END_SRC
**** TODO Migrate out of custom-set-variables?
**** TODO Fix Org fonts
*** Theme and font
...
#+END_SRC
**** paredit
Pseudo-structural editing of Lisp code. Fucking magical, but kind of hard to get into.
https://github.com/emacsmirror/paredit
Might be deprecated by smartparens (https://github.com/Fuco1/smartparens)
Also worth checking out: lispyville (https://github.com/noctuid/lispyville) because it's geared towards evil users (like me)
#+NAME: paredit
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package paredit
    :config
...
#+END_SRC
***** TODO Look into replacing with smartparens or lispyville
***** TODO Learn better and unleash it's full power
