...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package exwm-config
    ...
    ;; Start EXWM
    (require 'exwm-randr)
    (setq exwm-randr-workspace-output-plist '(0 "VGA-0" 1 "DVI-I-1" 2 "DVI-I-1" 3 "DVI-I-1" 4 "DVI-I-1" 5 "DVI-I-1" 6 "VGA-0" 7 "VGA-0" 8 "VGA-0" 9 "VGA-0"))
    (add-hook 'exwm-randr-screen-change-hook
              (lambda ()
                (start-process-shell-command
                 "xrandr" nil "xrandr --output VGA-0 --right-of DVI-I-1 --auto")))
    (exwm-enable)
    (exwm-randr-enable))
#+END_SRC
** Org
