...
#+END_SRC
** Publishing
For exporting blog posts to my blog.
#+NAME: publishing
#+BEGIN_SRC emacs-lisp :tangle yes
    (setq blog-header-file "~/Website/templates/header.html")
  ...
  <li><a href='/archive.html'>Archive</a></li>
    ...
    (setq org-publish-project-alist
          '(("blog-blog"
             ...
             :base-extension "org"
             :publishing-directory "~/Website/templates/blog"
             :recursive t
             :publishing-function org-html-publish-to-html
             :html-head-include-default-style nil
             :html-head-include-scripts nil
             :html-preamble "hitlergroet"
            ("blog-static"
             :base-directory "~/Website/org"
             :base-extension "css\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3\\|ogg\\|swf"
             :publishing-directory "~/Website/static/blog"
             :recursive t
             :publishing-function org-publish-attachment)
            ("blog"
             :components ("blog-blog" "blog-static")))))
#+END_SRC
** Custom code
